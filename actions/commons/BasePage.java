...
public class BasePage {
    ...
    public void selectItemInDropdown(WebDriver driver, String parentLocator, String childILocator, String ItemTextExpected) {
        ...
        List<WebElement> speedDropdownItems = new WebDriverWait(driver, Duration.ofSeconds(longTimeout)).until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(childILocator)));
